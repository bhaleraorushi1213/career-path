    ...
    <>
      <div className="pt-24" style={{ scrollbarWidth: "thin", scrollbarColor: "#2a3d52 #10151c" }}>
        <div className="px-4 sm:px-6 lg:px-8 py-6 border-b-[#1e2a38]">
          <div className="max-w-full flex flex-col sm:flex-row sm:items-end gap-8">
              ...
              <div className="bg-[#1e2a38]/50 border border-[#2a3d52] rounded-xl p-4 flex items-center justify-between">
                <div className="text-sm flex items-start gap-2">
                  <p className="text-white font-medium">Pro-tip: <span className="text-[#7a90a4]">
                    Drag and drop cards to move them between columns. Click the <span className="text-[#d9a441] font-bold">&apos;+&apos;</span> icon or click <span className="text-gray-300/90">&apos;Add Job&apos;</span> to add a new job application.</span></p>
                </div>
              </div>
            </div>
          </div>
...
const Dashboard = async () => {
  return (
    <Suspense fallback={
      <Loader2Icon
        className="mx-auto h-screen flex justify-center items-center size-16 animate-spin "
      />
    }>
      <DashboardPage />
    </Suspense>
